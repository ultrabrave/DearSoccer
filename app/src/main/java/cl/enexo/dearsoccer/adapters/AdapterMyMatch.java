 ...
 */
public class AdapterMyMatch extends FirebaseRecyclerAdapter<Match, CreatedHolder> {
    Activity activity;
    public AdapterMyMatch(Class<Match> modelClass, int modelLayout, Class<CreatedHolder> viewHolderClass, Query ref, Activity activity) {
