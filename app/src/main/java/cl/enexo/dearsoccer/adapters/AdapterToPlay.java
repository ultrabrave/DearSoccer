 ...
 */
public class AdapterToPlay extends FirebaseRecyclerAdapter<Match, ToPlayHolder> {
    Activity activity;
    public AdapterToPlay(Class<Match> modelClass, int modelLayout, Class<ToPlayHolder> viewHolderClass, Query ref, Activity activity) {
        super(modelClass, modelLayout, viewHolderClass, ref);
        this.activity =  activity;
    }

    @Override
    protected void populateViewHolder(ToPlayHolder viewHolder, Match model, int position) {
